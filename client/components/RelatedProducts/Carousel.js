...
const Carousel = {
  // total no of items
  numCards: document.querySelectorAll(".relatedProductCard").length,
  ...
  init: function() {
    ...
    document.querySelectorAll(".relatedProductCard").forEach(function(element, index) {
  ...
  changeOrder: function() {
    ...
    for(let i=this.current; i<=this.numCards; i++) {
      document.querySelector(".relatedProductCard[data-position='" + i + "']").style.order = order;
      order++;
    }
